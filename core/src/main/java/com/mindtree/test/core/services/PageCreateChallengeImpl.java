...
@Component(service = PageCreateChallengeInterface.class, immediate = true)
public class PageCreateChallengeImpl implements PageCreateChallengeInterface {
	...
	@Override
	public List<Page> getCSVPages() {
		// TODO Auto-generated method stub

		List<Page> createdPages = new LinkedList<>();
		List<PageCreationModel> pageProperties = getCSVContent();
	...
	private List<PageCreationModel> getCSVContent() {
		// TODO Auto-generated method stub
